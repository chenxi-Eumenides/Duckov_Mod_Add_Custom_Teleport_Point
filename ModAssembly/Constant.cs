namespace Add_Custom_Teleport_Point
{
    public static class Constant
    {
        ...
        public const string SCENE_ID_HIDDENWAREHOUSE_UNDER = "Level_HiddenWarehouse_CellarUnderGround";
        public const string SCENE_ID_FARM = "Level_Farm_01";
        ...
        public const string DEFAULT_JLAB_INTERACT_NAME = "前往J-Lab";
        public const string DEFAULT_FARM_INTERACT_NAME = "前往农场镇";
        public const string DEFAULT_GROUNDZERO_INTERACT_NAME = "前往零号区";
        public const string DEFAULT_HIDDENWAREHOUSE_INTERACT_NAME = "前往仓库区";
    }
}
